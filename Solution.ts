...
class Trie {
    ...
    addWordInReverse(word: string, indexInWordsContainer: number): void {
     ...
     */
    updateTrieNode(current: TrieNode, wordLength: number, indexInWordsContainer: number): void {
    ...
    findIndexOfLongestCommonSuffix(suffix: string): number {
        let current = this.root;
